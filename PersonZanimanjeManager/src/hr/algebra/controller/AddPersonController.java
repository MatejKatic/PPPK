...
public class AddPersonController implements Initializable {
    ...
    @FXML
    private ComboBox<ZanimanjeViewModel> cbZanimanje;

    private static ComboBox<ZanimanjeViewModel> cbZanimanjeOut;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        initValidation();
        cbZanimanjeOut = cbZanimanje;
        cbZanimanje.setItems(ListZanimanjeController.zanimanjes);
    ...
    private boolean formValid() {
        ...
        if (cbZanimanje.getSelectionModel().getSelectedItem() == null) {
            ok.set(false);
    ...
    private void commit(ActionEvent event) {
        ...
        if (formValid()) {
            ...
            ListPeopleController.selectedPersonViewModel.getPerson().setZanimanjeID(cbZanimanje.getSelectionModel().getSelectedItem().getZanimanje());
    ...
    public static void fillForm() {
         ...
         try {
            Integer idKlub = ListPeopleController.selectedPersonViewModel.getPerson().getZanimanjeID().getIDZanimanje();
            ZanimanjeViewModel get = ListZanimanjeController.zanimanjes.filtered(kvm -> kvm.getZanimanje().getIDZanimanje()== idKlub).get(0);
            cbZanimanjeOut.getSelectionModel().select(get);
        } catch (Exception e) {
        }
