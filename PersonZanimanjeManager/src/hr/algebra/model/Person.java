...
public class Person implements Serializable {
    ...
    @JoinColumn(name = "ZanimanjeID", referencedColumnName = "IDZanimanje")
    @ManyToOne
    ...
    public Person(Integer iDPerson, String firstName, String lastName, int age, String email, Zanimanje zanimanje) {
        this.iDPerson = iDPerson;
        this.firstName = firstName;
        this.lastName = lastName;
        this.age = age;
        this.email = email;
        this.zanimanjeID = zanimanje;
    }
    ...
    public String toString() {
     ...
     public void updateDetails(Person data) {
        ...
        this.zanimanjeID = data.getZanimanjeID();
    }
